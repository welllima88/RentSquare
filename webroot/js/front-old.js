...
$(window).ready(function(){
	...
	Cufon.replace('h3, #main-nav p, .home-box p, #slider p, .copy, .main-nav-item, .footer-nav-item', {'hover': true, 'fontFamily': 'GaramondPro'});
	Cufon.replace('', {'hover': true, 'fontFamily': 'HelveticaThin'});
	Cufon.now();

	//	Slider Arrows
	////////////////////////////////////////

	var prevOffset = parseInt($('#control-container #prev').css('left'));
	var nextOffset = parseInt($('#control-container #next').css('right'));
	var offset = -50;

	$('#control-container').hover(
		function(){
			$('#control-container #prev').stop(true, false).animate({'left': offset}, 300);
			$('#control-container #next').stop(true, false).animate({'right': offset}, 300);
		},
		function(){
			$('#control-container #prev').stop(true, false).animate({'left': prevOffset}, 300);
			$('#control-container #next').stop(true, false).animate({'right': nextOffset}, 300);
		}
	);
	...
	$('#slider').width(imageWidth * numImages);
	...
	$('#prev').click(function(){
		if(count != 0)
			...
			goToSlide(numImages - 1);
	});

    //	Hide input values on focus
    ////////////////////////////////////////

    $('input:text').not('#UserPlaceholder').focus(function(){
  ...
  $('#learn_more').click(function(e){
    e.preventDefault();
  	$('html,body').animate({scrollTop: $(".mobile_slide").offset().top }, 700, "swing");
  });
});


//	Sets slider interval and slides
////////////////////////////////////////
...
function slider()
{
	sliderInterval = setInterval(function(){
		...
		if(count + 1 != numImages)
		{
    		$('#slider').stop(true, false).animate({left: '-=' + imageWidth +'px'}, 700, 'easeInOutExpo');
    		//$('.slider-nav').eq(count).removeClass('active').next().addClass('active');
    		count++;
		}
		else
		{
...
function goToSlide(slide)
{
	...
	$('#slider').stop(true, false).animate({left: (-imageWidth * slide) +'px'}, 700, 'easeInOutExpo');
	//$('.slider-nav').eq(count).removeClass('active');
	//$('.slider-nav').eq(slide).addClass('active');
	count = slide;
	slider();
}

//	Change password from text to stars
////////////////////////////////////////
function setPass() {
	if(document.getElementById('UserPlaceholder'))
	document.getElementById('UserPlaceholder').style.display = 'none';
	if(document.getElementById('UserPassword')){
	  document.getElementById('UserPassword').style.display = 'inline';
...
function checkPass() {
  if(document.getElementById('UserPassword')){
    ...
    {
        document.getElementById('UserPlaceholder').style.display = 'inline';
