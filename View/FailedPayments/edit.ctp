...
<?php echo $this->Form->create('FailedPayment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Failed Payment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FailedPayment.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FailedPayment.id'))); ?></li>
