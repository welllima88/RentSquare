...
<?php echo $this->Form->create('AutoPayment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Auto Payment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AutoPayment.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AutoPayment.id'))); ?></li>
