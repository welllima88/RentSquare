<?php
  ...
  $notClosed = $openMaint + $pendingMaint;
  if($notClosed != 0){ $mainCount = ' <span class="unread_count maintenance_count">'. $notClosed . '</span>'; } else { $mainCount = ''; }
?>
<!--
  <div class="menu_item">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"  x="0px" y="0px" width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
        ...
        <path class="svg_initial" d="M55.396,46.507c-0.257-0.251-0.527-0.466-0.811-0.659l0.023-0.032c0,0-22.539-16.18-23.365-15.349  C30.413,31.3,46.591,53.833,46.591,53.833l0.029-0.028c0.195,0.289,0.411,0.559,0.662,0.812c2.239,2.238,5.871,2.238,8.113,0  C57.625,52.379,57.625,48.746,55.396,46.507z"/>
        <path class="svg_initial" d="M50.287,24.999c-1.035,0-1.875-0.84-1.875-1.875v-5.078c0-1.035,0.84-1.875,1.875-1.875l0,0c1.036,0,1.875,0.84,1.875,1.875  v5.078C52.162,24.159,51.323,24.999,50.287,24.999L50.287,24.999z"/>
        <path class="svg_initial" d="M37.952,28.304c-0.896,0.518-2.044,0.21-2.562-0.687l-2.539-4.397c-0.518-0.896-0.21-2.044,0.687-2.562l0,0  c0.897-0.518,2.044-0.21,2.562,0.687l2.539,4.397C39.156,26.639,38.85,27.786,37.952,28.304L37.952,28.304z"/>
        <path class="svg_initial" d="M28.922,37.333c-0.518,0.896-1.664,1.204-2.561,0.686l-4.398-2.539c-0.896-0.518-1.203-1.665-0.686-2.562l0,0  c0.518-0.897,1.665-1.204,2.562-0.687l4.397,2.539C29.133,35.29,29.44,36.436,28.922,37.333L28.922,37.333z"/>
        <path class="svg_initial" d="M25.617,49.668c0,1.035-0.84,1.875-1.875,1.875l-5.078,0.001c-1.035,0-1.875-0.841-1.875-1.876l0,0  c0-1.036,0.841-1.875,1.876-1.875h5.077C24.777,47.793,25.617,48.632,25.617,49.668L25.617,49.668z"/>
        <path class="svg_initial" d="M28.923,62.003c0.518,0.896,0.21,2.043-0.687,2.561l-4.398,2.541c-0.896,0.518-2.043,0.209-2.561-0.688l0,0  c-0.519-0.896-0.21-2.045,0.687-2.562l4.397-2.538C27.258,60.799,28.404,61.106,28.923,62.003L28.923,62.003z"/>
        <path class="svg_initial" d="M37.953,71.032c0.896,0.518,1.203,1.664,0.686,2.561l-2.539,4.4c-0.517,0.896-1.665,1.202-2.562,0.685l0,0  c-0.897-0.517-1.204-1.666-0.687-2.562l2.539-4.396C35.908,70.822,37.055,70.515,37.953,71.032L37.953,71.032z"/>
        <path class="svg_initial" d="M62.621,71.032c0.896-0.518,2.044-0.211,2.562,0.686l2.541,4.399c0.519,0.896,0.208,2.042-0.688,2.56l0,0  c-0.895,0.52-2.045,0.211-2.562-0.686l-2.537-4.396C61.418,72.698,61.724,71.552,62.621,71.032L62.621,71.032z"/>
        <path class="svg_initial" d="M71.65,62.003c0.518-0.896,1.665-1.205,2.562-0.688l4.4,2.54c0.896,0.517,1.2,1.665,0.683,2.562l0,0  c-0.514,0.896-1.664,1.205-2.561,0.688l-4.396-2.539C71.441,64.048,71.133,62.901,71.65,62.003L71.65,62.003z"/>
        <path class="svg_initial" d="M74.955,49.668c0-1.035,0.84-1.876,1.875-1.876l5.081,0c1.034-0.001,1.872,0.842,1.872,1.877l0,0  c0.004,1.033-0.839,1.876-1.874,1.876l-5.077-0.001C75.797,51.544,74.957,50.705,74.955,49.668L74.955,49.668z"/>
        <path class="svg_initial" d="M71.65,37.334c-0.518-0.896-0.211-2.044,0.686-2.562l4.4-2.541c0.895-0.518,2.042-0.207,2.56,0.689l0,0  c0.521,0.893,0.212,2.044-0.685,2.562l-4.398,2.538C73.316,38.538,72.171,38.231,71.65,37.334L71.65,37.334z"/>
  ...
  <div class="menu_item"><span id="hdr_Payments">
      ...
      Payments', array('controller' => 'Billing', 'action' => 'index'),array('escape'=>false)); ?>
  </span>
  </div><!-- .menu_item -->
  <div class="menu_item"><span id="hdr_Units">
	    <?php echo $this->ExHtml->link('
        ...
        Units', array('controller' => 'Units', 'action' => 'index'),array('escape'=>false));?>
        </span>
	</div><!-- .menu_item -->
