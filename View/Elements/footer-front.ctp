<div class="wrapper">
        <div class="footer_cta">
                Ready to get started? <?php echo $this->Html->link(h('Sign Up Today'),array('controller' => 'users', 'action' => 'register','full_base' => true),array('class'=>'animated bounce'));?>
        </div><!-- /.footer_cta -->
	<div id='footer-nav'>
		<?php
		...
		<div class="footer_credits">
			<?php 
			 ...
			 ?>
			&copy; RentSquare, LLC.  All Rights Reserved.
		</div><!-- /.footer_credits -->
	</div><!-- #footer-nav -->
</div><!-- /.wrapper -->
