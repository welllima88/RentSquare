...
<div class="mobile_promo">
  <div class="content_wrapper">
  		...
  		<div class="promo_content animated fadeInDown">
  			<h2>Pay Rent<br>
          On The Go.</h2>

          Anytime. Anywhere. All from the<br>
          convenience of your smart phone.<br><br><br>
          <?php echo $this->Html->link(h('Try RentSquare'),array('controller' => 'users', 'action' => 'register','full_base' => true),array('class'=>'white_button'));?> <a href="#learn_more" class="learn_more_mobile" id="learn_more_mobile"> or learn more &#x25BE;</a>
  		</div><!-- .promo_content -->
  </div><!-- .content_wrapper -->
</div><!-- .mobile_promo -->
<div class="mobile_slider">
  <div class="cycle-slideshow"
	...
	<div class="cycle-prev"><?php echo $this->Html->image('left-slider-dark.png', array('alt' => 'Previous Slide')); ?></div>
    	<div class="cycle-next"><?php echo $this->Html->image('right-slider-dark.png', array('alt' => 'Next Slide')); ?></div>
	</div>
