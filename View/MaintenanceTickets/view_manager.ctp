  ...
  <div class="block_content">
    ...
    <br>
      ...
      <button type="button" id="carbtn0" data-toggle="modal" data-target="#myModal" data-local="#myCarousel">
        <img width="102" height="102" src="<?php echo Router::url('/',true); ?>files/<?php echo $ticket['MaintenanceTicket']['image_url']; ?>" alt=""/>
      </button>
      ...
      <button type="button" id="carbtn0" data-toggle="modal" data-target="#myModal" data-local="#myCarousel">
           <img width="102" height="102" src="<?php echo Router::url('/',true); ?>files/<?php echo $ticket['MaintenanceTicket']['image_url_2']; ?>" alt=""/>
      </button>
      ...
      <button type="button" id="carbtn0" data-toggle="modal" data-target="#myModal" data-local="#myCarousel">
          <img width="102" height="102" src="<?php echo Router::url('/',true); ?>files/<?php echo $ticket['MaintenanceTicket']['image_url_3']; ?>" alt=""/>
      </button>
      ...
      <button type="button" id="carbtn0" data-toggle="modal" data-target="#myModal" data-local="#myCarousel">
          <img width="102" height="102" src="<?php echo Router::url('/',true); ?>files/<?php echo $ticket['MaintenanceTicket']['image_url_4']; ?>" alt=""/>
      </button>
