...
class BillingController extends AppController {
    ...
    public function indexTmpTable($status = null)
    {
        ...
        } else
        {
            ...
            $lastRec = $this->$tmpModel->find('first', array(
                'order'  => array('id' => 'desc'),
                'fields' => array('id')
            ));
            ...
            $units = $this->Billing->Unit->find('all', array(
                'conditions' => array(
                    'Unit.active'      => 1,
