        ...
        elseif(strtotime($billing_cycle['Billing']['billing_end']) < time()):
            ...
            foreach($tenants as $tenant):
              if($tenant['User']['email_for_rent'] == "1"):
                ...
                if((date('Y-m-d',strtotime($billing_cycle['Billing']['billing_end'])) == date('Y-m-d',time())) ||
                   (date('Y-m-d',strtotime($billing_cycle['Billing']['billing_end'])) == date('Y-m-d',strtotime('+2 days')))){
